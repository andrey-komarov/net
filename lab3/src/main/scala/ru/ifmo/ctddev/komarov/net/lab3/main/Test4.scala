...
import ru.ifmo.ctddev.komarov.net.lab3.state.{RevisionList, RevisionFiles, Everything}
...
object Test4 {
  def main(args: Array[String]) {
    ...
    e.revisions = e.revisions.+((e.crypto.pubKey, Set(RevisionFiles(???, 0, List.empty))))
